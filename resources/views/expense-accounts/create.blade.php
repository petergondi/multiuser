...
<div class="basic-form-area mg-tb-15">
    <div class="container-fluid">
      ...
      <p>
       <strong>Create Expense Accounts</strong>
      </p>
    </section>
                    </div>
                                        ...
                                        <form action="#" class='form-horizontal'>
                                            ...
                                            <div class="form-group-inner">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                        <input  type="text" name="code" class="form-control" placeholder="expense code" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group-inner">
                                                <div class="row">
                                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                        <label  class="login2 pull-right pull-right-pro">Account Description</label>
                                                    </div>
                                                    <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
